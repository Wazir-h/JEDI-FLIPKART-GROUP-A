...
public class GymOwnerDAO {
    ...
    public static void OwnerCredentialsInitialization(){
        try{
...
//        for(String key : OwnerCredentials.keySet()){
//            System.out.println(key + ": " + OwnerCredentials.get(key));
//        }
    }
...
//        System.out.println("Error here approve gym");
    ...
    public static boolean authenticateUser(String username, String password) {
        if (OwnerCredentials.containsKey(username)) {
            ...
            System.out.println("Gym owner password: " + storedPassword);
            System.out.println("Gym owner stored: " + username);
